...
for row in album_rows:
    ...
    for part in [item.strip() for item in genre.split(",") if item.strip()]:
        genres.add(part.casefold())
        ...
        fresh_tracks.append(
            {
                ...
                "artist": album["artistName"] or "Unknown artist",
                "genre": album["genre"],
...
print(f"albums={len(summary_albums)} tracks={track_count} genres={len(genres)}")
